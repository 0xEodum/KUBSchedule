...
class PlaceSchedulePage extends StatefulWidget {
  final Map<String, dynamic> placeData;
  final DateTime currentDate;

  const PlaceSchedulePage(
      {Key? key, required this.placeData, required this.currentDate})
      : super(key: key);

  @override
  _PlaceSchedulePageState createState() => _PlaceSchedulePageState();
}

class _PlaceSchedulePageState extends State<PlaceSchedulePage> {
  ...
  Future<void> fetchLessonsForRange(DateTime start, DateTime end, {bool clearCache = false}) async {
    ...
    final url = Uri.parse(
        '$apiUrl/api/timetable/lessons/viewer?start_date=$startString&end_date=$endString&place=${widget.placeData['id']}');
        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  SvgPicture.asset('assets/place_icon.svg',
